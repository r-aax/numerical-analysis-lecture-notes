...
Матрица данной системы уравнений является трехдиагональной, с диагональным преобладанием, поэтому система является разрешимой и решается методом прогонки.

Кроме того, неявная разностная схема является устойчивой, что делает ее использование более предпочтительным, чем использование явной схемы.
