...
\frac{\partial \rho w}{\partial t} + \frac{\partial \rho w u}{\partial x} + \frac{\partial \rho w v}{\partial y} + \frac{\partial (\rho w^2 + p)}{\partial z} = 0 \\
...
где $\rho$ - плотность; $u$ - скорость; $p = (\gamma - 1) \rho \epsilon$ - давление; $e$ - удельная энергия $e = \epsilon + \frac{u^2}{2}$.
...
После расчета промежуточных величин $\tilde{u}_i^{n + 1}$ и $\tilde{e}_i^{n + 1}$ мы можем точно так же вычислять значения данных величин на левой и правой границе ячеек:

\begin{eqnarray}
\tilde{u}_{i + \frac{1}{2}}^{n + 1} = \frac{\tilde{u}_i^{n + 1} + \tilde{u}_{i + 1}^{n + 1}}{2} \\
\tilde{u}_{i - \frac{1}{2}}^{n + 1} = \frac{\tilde{u}_i^{n + 1} + \tilde{u}_{i - 1}^{n + 1}}{2} \\
\tilde{e}_{i + \frac{1}{2}}^{n + 1} = \frac{\tilde{e}_i^{n + 1} + \tilde{e}_{i + 1}^{n + 1}}{2} \\
\tilde{e}_{i - \frac{1}{2}}^{n + 1} = \frac{\tilde{e}_i^{n + 1} + \tilde{e}_{i - 1}^{n + 1}}{2}
\end{eqnarray}
...
\begin{eqnarray}
\Delta M_{i + \frac{1}{2}}^n = \rho_i^n S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} > 0 \\
\Delta M_{i + \frac{1}{2}}^n = \rho_{i + 1}^n S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} < 0
\end{eqnarray}
...
Аналогично рассматриваются потоки количества движения и количества энергии через границы.

\begin{eqnarray}
\Delta (Mu)_{i + \frac{1}{2}}^n = \rho_i^n \tilde{u}_i^{n + 1} S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} > 0 \\
\Delta (Mu)_{i + \frac{1}{2}}^n = \rho_{i + 1}^n \tilde{u}_{i + 1}^{n + 1} S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} < 0 \\
\Delta (Mu)_{i - \frac{1}{2}}^n = \rho_{i - 1}^n \tilde{u}_{i - 1}^{n + 1} S \tau \tilde{u}_{i - \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i - \frac{1}{2}}^{n + 1} > 0 \\
\Delta (Mu)_{i - \frac{1}{2}}^n = \rho_i^n S \tilde{u}_i^{n + 1} \tau \tilde{u}_{i - \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i - \frac{1}{2}}^{n + 1} < 0
\end{eqnarray}

\begin{eqnarray}
\Delta (Me)_{i + \frac{1}{2}}^n = \rho_i^n \tilde{e}_i^{n + 1} S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} > 0 \\
\Delta (Me)_{i + \frac{1}{2}}^n = \rho_{i + 1}^n \tilde{e}_{i + 1}^{n + 1} S \tau \tilde{u}_{i + \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i + \frac{1}{2}}^{n + 1} < 0 \\
\Delta (Me)_{i - \frac{1}{2}}^n = \rho_{i - 1}^n \tilde{e}_{i - 1}^{n + 1} S \tau \tilde{u}_{i - \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i - \frac{1}{2}}^{n + 1} > 0 \\
\Delta (Me)_{i - \frac{1}{2}}^n = \rho_i^n S \tilde{e}_i^{n + 1} \tau \tilde{u}_{i - \frac{1}{2}}^{n + 1}, \ \tilde{u}_{i - \frac{1}{2}}^{n + 1} < 0
\end{eqnarray}

После вычисления потоков масс, а также количества движения и количества энергии через все границы всех ячеек лагранжев этап считается завершенным.
...
M_i^{n + 1}u_i^{n + 1} = M_i^n u_i^n - \Delta (Mu)_{i + \frac{1}{2}}^n + \Delta (Mu)_{i - \frac{1}{2}}^n \\
M_i^{n + 1}e_i^{n + 1} = M_i^n e_i^n - \Delta (Me)_{i + \frac{1}{2}}^n + \Delta (Me)_{i - \frac{1}{2}}^n
\end{eqnarray}
...
u_i^{n + 1} = \frac{\rho_i^n}{\rho_i^{n + 1}}u_i^n + \frac{\Delta (Mu)_{i - \frac{1}{2}}^n - \Delta (Mu)_{i + \frac{1}{2}}^n }{\rho_i^{n + 1}Sh} \\
e_i^{n + 1} = \frac{\rho_i^n}{\rho_i^{n + 1}}e_i^n + \frac{\Delta (Me)_{i - \frac{1}{2}}^n - \Delta (Me)_{i + \frac{1}{2}}^n }{\rho_i^{n + 1}Sh}
\end{eqnarray}
